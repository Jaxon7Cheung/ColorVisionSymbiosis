...
- (void)setUI {
    ...
    self.circleView = [[UIView alloc] initWithFrame: CGRectMake(0, _MINIGAP, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height / 7)];
...
//    self.passwordField.textContentType = UITextContentTypePassword;
    ...
    [self.confirmPasswordField mas_makeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(_Screen_WIDTH * 0.76, _MINIGAP * 2.2));
        make.top.mas_equalTo(self.passwordField.mas_bottom).mas_offset(_MINIGAP * 2);
        make.centerX.mas_equalTo(self);
    }];
...
//    self.confirmPasswordField.autocorrectionType = UITextAutocorrectionTypeNo;
    ...
    [self.registerButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(_Screen_WIDTH * 0.76, _MINIGAP * 2.2));
        make.top.mas_equalTo(self.confirmPasswordField.mas_bottom).mas_offset(_MINIGAP * 1.5);
        make.centerX.mas_equalTo(self);
    }];
    ...
    [self.confirmPasswordLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(self.confirmPasswordField.mas_top).mas_offset(-_MINIGAP / 3);
        make.left.mas_equalTo(self.phoneField);
    }];
...
//        self.wrongMessageLabel.text = @"请输入手机号或密码";
        ...
        [self.wrongMessageLabel mas_makeConstraints:^(MASConstraintMaker *make) {
                ...
                make.top.mas_equalTo(self.confirmPasswordField.mas_bottom).mas_offset(9.5);
        }];
    }
}

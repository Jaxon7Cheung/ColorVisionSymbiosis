...
//    CircleLayout* circleLayout = [[CircleLayout alloc] init];
    ...
    flowLayout.minimumLineSpacing = _MINIGAP;
    flowLayout.minimumInteritemSpacing = _MINIGAP;
    CGFloat itemSize = (_Screen_WIDTH * 0.60 - _MINIGAP * 2) / 3;
//    flowLayout.itemSize = CGSizeMake(_Screen_WIDTH * 0.21 - _MINIGAP * 2 / 3, _Screen_WIDTH * 0.21 - _MINIGAP * 2 / 3);
    ...
    [self.collectionView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(_Screen_WIDTH * 0.63);
        make.centerY.mas_offset(-_MINIGAP * 5);
...
//    }];
    ...
    [self.titleView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(_Screen_WIDTH, _MINIGAP * 3.9));
        make.top.mas_equalTo(self.collectionView.mas_bottom).mas_offset(_MINIGAP / 2);
        make.centerX.mas_equalTo(self);
    }];
    ...
    [self.loginButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(_Screen_WIDTH * 0.66, _MINIGAP * 2));
        make.top.mas_equalTo(self.titleView.mas_bottom).mas_offset(_MINIGAP * 3);
        make.centerX.mas_equalTo(self);
    }];
    ...
    [self.registerButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(_Screen_WIDTH * 0.66, _MINIGAP * 2));
        make.top.mas_equalTo(self.loginButton.mas_bottom).mas_offset(_MINIGAP);
        make.centerX.mas_equalTo(self);
    }];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.item == 4) {
        ...
        NSInteger along = _Screen_WIDTH * 0.21 - _MINIGAP * 2 / 3;
        eyeIcon.frame = CGRectMake(along / 6, along / 6, _Screen_WIDTH * 0.14 - _MINIGAP * 4 / 9, _Screen_WIDTH * 0.14 - _MINIGAP * 4 / 9);

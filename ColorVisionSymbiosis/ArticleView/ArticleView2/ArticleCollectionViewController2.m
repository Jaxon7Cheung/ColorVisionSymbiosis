//
//  ArticleCollectionViewController2.m
...
#import "myCollectionView2.h"
//#import "cellViewController.h"
#import "MyLayout.h"
#import "Masonry.h"
#import "labelViewController2.h"
#import "shuju2.h"

#define SIZE_WIDTH ([UIScreen mainScreen].bounds.size.width)
#define SIZE_HEIGHT ([UIScreen mainScreen].bounds.size.height)

@interface ArticleCollectionViewController2 () <UICollectionViewDelegate>

@property (nonatomic, strong) myCollectionView2* collectionView;
...
@implementation ArticleCollectionViewController2

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.data = [[shuju2 alloc] init];
...
- (void)collectionAdd {
    ...
    self.collectionView = [[myCollectionView2 alloc] initWithFrame:self.view.bounds collectionViewLayout:layout];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    labelViewController2* VC = [[labelViewController2 alloc] init];

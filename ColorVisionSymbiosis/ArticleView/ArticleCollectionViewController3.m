//
//  ArticleCollectionViewController3.m
...
#import "myCollectionView3.h"
//#import "cellViewController.h"
#import "MyLayout.h"
#import "Masonry.h"
#import "labelViewController3.h"
#import "shuju3.h"

#define SIZE_WIDTH ([UIScreen mainScreen].bounds.size.width)
#define SIZE_HEIGHT ([UIScreen mainScreen].bounds.size.height)

@interface ArticleCollectionViewController3 () <UICollectionViewDelegate>

@property (nonatomic, strong) myCollectionView3* collectionView;
...
@implementation ArticleCollectionViewController3

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.data = [[shuju3 alloc] init];
...
- (void)collectionAdd {
    ...
    self.collectionView = [[myCollectionView3 alloc] initWithFrame:self.view.bounds collectionViewLayout:layout];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    labelViewController3* VC = [[labelViewController3 alloc] init];

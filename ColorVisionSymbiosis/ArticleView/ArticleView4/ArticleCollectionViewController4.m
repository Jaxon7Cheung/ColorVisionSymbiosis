//
//  ArticleCollectionViewController4.m
...
#import "myCollectionView4.h"
//#import "cellViewController.h"
#import "MyLayout.h"
#import "Masonry.h"
#import "labelViewController4.h"
#import "shuju4.h"

#define SIZE_WIDTH ([UIScreen mainScreen].bounds.size.width)
#define SIZE_HEIGHT ([UIScreen mainScreen].bounds.size.height)

@interface ArticleCollectionViewController4 () <UICollectionViewDelegate>

@property (nonatomic, strong) myCollectionView4* collectionView;
...
@implementation ArticleCollectionViewController4

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.data = [[shuju4 alloc] init];
...
- (void)collectionAdd {
    ...
    self.collectionView = [[myCollectionView4 alloc] initWithFrame:self.view.bounds collectionViewLayout:layout];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    labelViewController4* VC = [[labelViewController4 alloc] init];

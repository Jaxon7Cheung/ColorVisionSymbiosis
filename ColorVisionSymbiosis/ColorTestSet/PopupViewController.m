...
//    cell.label3.text = data[@"Point"];
    cell.imageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"%ldaa.jpg", indexPath.item + 2]];
...
//    cell.label3.text = @"3";
    if(indexPath.row == 0) {
        cell.label1.text = @"正解：3";
        cell.label2.text = @"我的：3";
        cell.label3.text = @"分析：蓝紫色盲";
    } else if(indexPath.row == 1) {
        cell.label1.text = @"正解：8";
        cell.label2.text = @"我的：5";
        cell.label2.textColor = [UIColor redColor];
        cell.label3.text = @"分析：绿色色盲";
    } else if(indexPath.row == 2) {
        cell.label1.text = @"正解：5";
        cell.label2.text = @"我的：5";
        cell.label3.text = @"分析：绿色色盲";
        ...
        cell.label1.text = @"正解：K";
        cell.label2.text = @"我的：K";
        cell.label3.text = @"分析：蓝紫色盲";
    } if(indexPath.row == 5) {
        cell.label1.text = @"正解：5";
        cell.label2.text = @"我的：8";
        cell.label2.textColor = [UIColor redColor];
        cell.label3.text = @"分析：红色色盲";
    } else if(indexPath.row == 6) {
        cell.label1.text = @"正解：8";
        cell.label2.text = @"我的：9";
        cell.label2.textColor = [UIColor redColor];
        cell.label3.text = @"分析：红色色盲";
    } else if(indexPath.row == 7) {
        cell.label1.text = @"正解：806";
        cell.label2.text = @"我的：806";
        cell.label3.text = @"分析：蓝紫色盲";
    } else {
        cell.label1.text = @"正解：6";
        cell.label2.text = @"我的：6";
        cell.label3.text = @"分析：绿色色盲";
    }

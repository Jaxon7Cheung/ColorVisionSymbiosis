...
- (void)viewDidLayoutSubviews {
    ...
    //更新标题位置
    self.titleView.frame = CGRectMake(0, self.config.titleViewHeight * 3.5 - self.config.titleViewHeight, self.contentView.bounds.size.width, self.config.titleViewHeight);
    
    //更新pageVC位置
    self.pageVC.view.frame = CGRectMake(0, self.config.titleViewHeight * 3.5, self.contentView.bounds.size.width, self.contentView.bounds.size.height - self.config.titleViewHeight);
